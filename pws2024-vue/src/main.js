...
import Analysis from './components/Analysis.vue' // Import the new Analysis component
...
const router = createRouter({
    ...
    routes: [
        ...
        { path: '/analysis', component: Analysis, icon: 'mdi-chart-timeline', title: 'Analysis', roles: [0] } // Add the Analysis route with role 0 access
    ]
})
